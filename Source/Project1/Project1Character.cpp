...
void AProject1Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AProject1Character::OnResetVR);
}


void AProject1Character::OnResetVR()
{
	// If Project1 is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in Project1.Build.cs is not automatically propagated
